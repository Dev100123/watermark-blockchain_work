...
def display_model(match, container=st):
    container.markdown("---")
    container.markdown(
        f"""
        <style>   
        ...
        <div class="certificate-container">
            <div class="cert-title">🔐 Model Certificate</div>
            <div class="cert-row"><span class="cert-value">{match}</span></div>
            <div class="footer-note">
                ⚙️ This certificate is generated base on the Model Prediction.
                <br/>
            </div>
        </div>
        """,
